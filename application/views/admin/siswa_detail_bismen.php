  ...
  <div class="container">
    ...
    <?php if ($row->status_kelulusan == "LULUS") { ?>
      <a style="margin-bottom: 20px;" type="button" class="btn btn-success btn-sm" href="<?php echo site_url('C_admin/siswa_print_bismen/'.$row->id_siswa); ?>" >Download Surat Kelulusan</a>
    <?php }else { ?>
